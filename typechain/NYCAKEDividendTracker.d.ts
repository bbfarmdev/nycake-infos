...
interface NYCAKEDividendTrackerInterface extends ethers.utils.Interface {
  functions: {
...
export class NYCAKEDividendTracker extends Contract {
  ...
  interface: NYCAKEDividendTrackerInterface;
