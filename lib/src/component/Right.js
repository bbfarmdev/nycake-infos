...
class Right extends react_1.Component {
    ...
    async componentDidMount() {
        ...
        (async () => {
            this.setState({ holders: await NYCakeContract_1.default.getNumberOfDividendTokenHolders() });
        });
    }
    render() {
        return jsx_runtime_1.jsxs("main", { children: [jsx_runtime_1.jsxs("div", { children: ["MarketCap", jsx_runtime_1.jsx("br", {}, void 0), jsx_runtime_1.jsxs("b", { children: ["$", Utils_1.default.numberWithCommas(ethers_1.utils.formatEther(this.state.marketCap))] }, void 0)] }, void 0), jsx_runtime_1.jsxs("div", { children: ["LP value", jsx_runtime_1.jsx("br", {}, void 0), jsx_runtime_1.jsxs("b", { children: ["$", Utils_1.default.numberWithCommas(ethers_1.utils.formatEther(this.state.lpValue))] }, void 0)] }, void 0), jsx_runtime_1.jsxs("div", { children: ["Holders", jsx_runtime_1.jsx("br", {}, void 0), jsx_runtime_1.jsx("b", { children: Utils_1.default.numberWithCommas(String(this.state.holders)) }, void 0)] }, void 0)] }, void 0);
    }
}
